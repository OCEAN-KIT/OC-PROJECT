...
import { transplantMethods, attachmentOptions, EMPTY_FORM } from './constants'
import type { SpeciesSection } from './constants'
...
export default function TransplantLogCard({ areaId, section }: Props) {
