    ...
    >
      <div className={`${REVIEW_GRID} items-center`}>
        ...
        <div className="flex min-w-0 items-center gap-1.5 text-gray-500">
          ...
          <time className="truncate" title={presentation.submittedAtLabel}>
        ...
        <div
          ...
          title={presentation.activityLabel}
        >
          {presentation.activityLabel}
        </div>

        <div className="flex min-w-0 items-center gap-1.5 text-gray-700">
          <User2 className="h-4 w-4 shrink-0 text-gray-400" />
          <span className="truncate" title={review.author}>
            {review.author}
          </span>
        </div>
        ...
        <div className="flex min-w-0 items-center gap-1.5 text-gray-600">
          ...
          <span className="truncate">{review.fileCount}개 파일</span>
        </div>
